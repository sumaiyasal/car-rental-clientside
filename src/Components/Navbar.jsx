      ...
      <div className="navbar container mx-auto ">
        ...
        {user && user?.email ? (
          <div className="navbar-end flex gap-2">
            ...
            <button
              onClick={signout}
              className="btn bg-white text-orange-500 border-2 border-orange-500 hover:bg-orange-500 hover:text-white font-bold"
            >
              Log Out
            </button>
          </div>
          ...
          <div className="navbar-end flex gap-2">
            ...
            <NavLink
              to="/signup"
              className="btn bg-white text-orange-500 border-2 border-orange-500 hover:bg-orange-500 hover:text-white"
            >
              Sign Up
            </NavLink>
          </div>
